...
export default function DesktopNavbar() {
  ...
  return (
    <header 
      className={`fixed top-0 w-[102vw] z-50 transition-all duration-500 ease-in-out ${
        isScrolled 
        ...
        <div className="flex items-center justify-between space-x-10">
          ...
          <div className="relative search-area" ref={searchContainerRef}>
            <div className={`flex items-center transition-all duration-300 rounded ${isSearchActive ? 'bg-black bg-opacity-90 border border-gray-800' : ''}`}>
              ...
              <div className={`overflow-hidden ease-in-out transition-all duration-300 ${isSearchActive ? 'w-100 opacity-100' : 'w-0 opacity-0'}`}>
                <input 
                  type="text" 
          ...
          <button 
            id="recommendBtn"
            className="flex items-center cursor-pointer px-6 py-1.5 rounded-full bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 transition-all duration-300 text-white text-sm font-medium shadow-lg group"
            onClick={(e) => {
              e.preventDefault();
              e.stopPropagation();
