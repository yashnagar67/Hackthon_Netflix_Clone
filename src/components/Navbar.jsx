        ...
        <div className="flex items-center justify-between space-x-4 md:space-x-6">
          ...
          >
            ...
            >
              ...
              <path d="M6.5 17.5L8.5 15.5M17.5 6.5L15.5 8.5M17.5 17.5L15.5 15.5M6.5 6.5L8.5 8.5" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            <span className="group-hover:tracking-wide transition-all duration-300">
              <span className="text-red-600 font-bold">AI</span> Recommend
            </span>
          </button>
